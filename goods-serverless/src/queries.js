...
module.exports = {
    getDakiList: "select id, name, image from dakimakura where name like $1 or brand like $1 or description like $1 and material between $2 and $3 order by id desc limit $4 offset $5",
